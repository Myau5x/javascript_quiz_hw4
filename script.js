var questions = [{question: "What operator we use in JS to check that values are equal and have equal type" , answers :["=","==","===","===="], correct: 2},{question: "What is the right way to create array " , answers :["['a','b','c']","('a','b','c')","{'a','b','c'}"], correct: 0},{question: "Which of the following is a valid type of function javascript supports?" , answers :["named function","anonymous function","Both of the above","None of the above"], correct: 2},{question: "Which built-in method sorts the elements of an array?" , answers :["changeOrder(order)","sort()","order()","None of the above."], correct: 1},{question: "Where is the correct place to insert a JavaScript?" , answers :["the <body> section","the <head> section","both are correct"], correct: 2}];
var timer = 75;
